...
folder <- 'C:\\Users\\Gosmo\\OneDrive\\Documents\\Studium-LED-PC\\3. Semseter\\Praktikum Private\\Schindler\\Berechungen\\processed_data_for_calc\\Profilometer_lens' # put your folder desitination hier where all the xlsx from lab class are stored
